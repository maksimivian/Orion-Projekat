document.addEventListener('DOMContentLoaded', function() {
    ...
    function resetSelections(levels) {
        ...
        // Clear the selected-info display
        updateSelectedInfo();
    ...
    function displayOpis(opis) {
        const infoContainer = document.getElementById('selected-info');
        infoContainer.innerHTML = `<p><strong>Opis:</strong> ${opis}</p>`;
    }
    ...
    function updateSelectedInfo() {
        ...
        if (selectedTechName) {
            infoHtml += `<p><strong>Tehnologija:</strong> ${selectedTechName}</p>`;
        }
        if (selectedSubTechName) {
            infoHtml += `<p><strong>Sub Tehnologija:</strong> ${selectedSubTechName}</p>`;
        }
        if (selectedProblemTypeName) {
            infoHtml += `<p><strong>Tip Problema:</strong> ${selectedProblemTypeName}</p>`;
        }
        if (selectedProblemLocationName) {
            infoHtml += `<p><strong>Lokacija Problema:</strong> ${selectedProblemLocationName}</p>`;
        }
